...
int decode_a(int memory_instruction,int R[],int instruction,int op,int busy[],int cycle,string hash[],int core,int ref_ins,bool blocked[],unordered_set<int>& rows_involved_when_blocked,unordered_map<int,int> row_blocking_sw[],unordered_map<int,int> row_blocking_lw[],int priority[],int *blocked_reg)
{
	...
	{	
		if(busy[r3]==1) *blocked_reg = r3;
		else if(busy[r2]==1) *blocked_reg = r2;
		else *blocked_reg = r1;
...
int decode_b(int memory_instruction,int R[],int instruction,int op,int busy[],int cycle,string hash[],int core,int ref_ins,bool blocked[],unordered_set<int>& rows_involved_when_blocked,unordered_map<int,int> row_blocking_sw[],unordered_map<int,int> row_blocking_lw[],int priority[],int *blocked_reg)
{
...
int decode_c(int memory_instruction,int end_of_instruction,int instruction,int cycle,int core,int ref_ins,bool blocked[],unordered_set<int>& rows_involved_when_blocked,unordered_map<int,int> row_blocking_sw[],unordered_map<int,int> row_blocking_lw[],int priority[],int* blocked_reg)
{
...
int decode_d(int memory_instruction,int R[],int instruction,int op,int core,int end_of_instruction,int busy[],int R_used[],int buffer[],bool blocked[],unordered_set<int>& rows_involved_when_blocked,unordered_map<int,int> row_blocking_sw[],unordered_map<int,int> row_blocking_lw[],int priority[],int *blocked_reg)
{
...
int decode_e(int memory_instruction,int R[],int instruction,int op,int busy[],int cycle,string hash[],int core,int ref_ins,bool blocked[],unordered_set<int>& rows_involved_when_blocked,unordered_map<int,int> row_blocking_sw[],unordered_map<int,int> row_blocking_lw[],int priority[],int* blocked_reg)
{
